...
public class UI {
	...
	public static ChessPosition readChessPosition(Scanner sc ) {
		try {
			...
			throw new InputMismatchException("Erro ao ler posicao do xadrez! Posicoes validas sao de a1 ate h8");
		}
	}
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		...
		if (!chessMatch.getCheckMate()) {
			...
			if (chessMatch.getCheck()) {
				System.out.println("O jogador " + chessMatch.getCurrentPlayer() + " esta em CHEQUE!");
			}
		}
			else {
